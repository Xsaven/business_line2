        ...
        <div class="cont row">
          <div class="data">
            <div class="info">
              ...
              <div>
                <div class="scores">{{task.cost}} {{declOfNum(task.cost,['балл','балла','баллов'])}}</div>
...
<!--          <v-get-task-report v-if="!user.can" status="no_can"/>-->
          ...
          <v-my-report v-else-if="Number(user.direction_id) !== Number(task.direction_id) || task.finished || !user.can" :task="task" :reports="reports" :report="task.finished ? task_report : undefined"/>
