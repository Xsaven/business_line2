...
namespace Lar\Layout {
     ...
     * @method \App\Components\Vue\Lock lock($id = null, array $attrs = [], ...$params) Add Component lock
     * @method \App\Components\Vue\Lock _lock($id = null, array $attrs = [], ...$params) Add Component lock to parent
